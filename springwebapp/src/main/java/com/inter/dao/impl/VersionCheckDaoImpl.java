...
public class VersionCheckDaoImpl implements VersionCheckDao {
	...
	public Map<String, Object> query1(String osType) {
	...
	public int query2(int currentVersionCodeParam, int currentVersionCodeDb) {
		String sql = "SELECT count(*) FROM app_version WHERE is_forced_update = 1 AND current_version_code > ? AND current_version_code <= ?";
		return jdbcTemplate.queryForObject(sql, new Object[] {currentVersionCodeParam, currentVersionCodeDb}, Integer.class);
	}
