...
public class EnterprisePhysicalDistributionHistoryListController {
	...
	public void setEnterprisePhysicalDistributionHistoryListService(EnterprisePhysicalDistributionHistoryListService enterprisePhysicalDistributionHistoryListService) {
		this.enterprisePhysicalDistributionHistoryListService = enterprisePhysicalDistributionHistoryListService;
	}
