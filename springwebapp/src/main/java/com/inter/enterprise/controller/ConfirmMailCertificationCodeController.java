...
public class ConfirmMailCertificationCodeController {
	...
	public void setConfirmMailCertificationCodeService(
			ConfirmMailCertificationCodeService confirmMailCertificationCodeService) {
		this.confirmMailCertificationCodeService = confirmMailCertificationCodeService;
	}
