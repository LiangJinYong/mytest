...
public class EnterprisePhysicalDistributionController {
	...
	public void setEnterprisePhysicalDistributionService(
			EnterprisePhysicalDistributionService enterprisePhysicalDistributionService) {
		this.enterprisePhysicalDistributionService = enterprisePhysicalDistributionService;
	}
