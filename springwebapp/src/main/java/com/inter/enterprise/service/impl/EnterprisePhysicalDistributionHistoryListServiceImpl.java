...
public class EnterprisePhysicalDistributionHistoryListServiceImpl implements EnterprisePhysicalDistributionHistoryListService {
	...
	public void setEnterprisePhysicalDistributionHistoryListDao(EnterprisePhysicalDistributionHistoryListDao enterprisePhysicalDistributionHistoryListDao) {
		this.enterprisePhysicalDistributionHistoryListDao = enterprisePhysicalDistributionHistoryListDao;
	}
