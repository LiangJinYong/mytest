...
public class LogServiceImpl implements LogService {
	...
	public void consumerQrLog(String token, String watermarkKey, String latitude, String longitude, String osType,
		...
		try {
			...
			int orderSeq = (Integer) seqAndOrder.get("ORDER_SEQ");
			...
			try {
				...
				try {
					logDao.insertConsumerQrLog(userNo, watermarkKey, sequence, orderSeq, longitude, latitude, generation, step,
	...
	public void consumerWatermarkLog(String token, String sequence, double latitude, double longitude, String osType,
		...
		try {
			...
			try {
				...
				logDao.insertConsumerWatermarkLog(userNo, watermarkKey, sequence, orderSeq, longitude, latitude, generation, step, mobilePhoneNumber, osType, device, currentVersionCode, time);
