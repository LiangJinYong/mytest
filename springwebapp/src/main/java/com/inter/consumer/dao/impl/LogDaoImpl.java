...
import com.inter.consumer.dao.LogDao;
...
public class LogDaoImpl implements LogDao {
	...
	public Map<String, Object> querySeqAndOrderByWatermarkKey(String watermarkKey) {
		String sql = "SELECT re_seq.SEQUENCE, lian_order_info.ORDER_SEQ, lian_order_info.GENERATION, lian_order_info.STEP FROM re_seq LEFT JOIN lian_order_info ON re_seq.ORDERNUMBER = lian_order_info.ORDER_SEQ WHERE WATERMARK_KEY = ?";
	...
	public void insertConsumerQrLog(int userNo, String watermarkKey, String sequence, int orderSeq, String longitude, String latitude,
		...
		jdbcTemplate.update(sql, new Object[] { userNo, watermarkKey, sequence, orderSeq, longitude, latitude, generation, step,
	...
	public void insertConsumerFailQrLog(int userNo, String watermarkKey, String longitude, String latitude,
		...
		String sql = "INSERT INTO app_log VALUES (null, ?, ?, null, null, ?, ?, ?, ?, ?, ?, ?, ?, ?, true, false)";
	...
	public Map<String, Object> querySeqAndOrderBySequence(String sequence) {
		String sql = "SELECT re_seq.WATERMARK_KEY, lian_order_info.ORDER_SEQ, lian_order_info.GENERATION, lian_order_info.STEP FROM re_seq LEFT JOIN lian_order_info ON re_seq.ORDERNUMBER = lian_order_info.ORDER_SEQ WHERE SEQUENCE = ?";
		return jdbcTemplate.queryForMap(sql, new Object[] { sequence });
	}

	public void insertConsumerWatermarkLog(int userNo, String watermarkKey, String sequence, int orderSeq, double longitude,
	...
	public void insertFailLog(int userNo, double longitude, double latitude, int generation, int step,
		...
		String sql = "INSERT INTO app_log VALUES (null, ?, null, null, null, ?, ?, ?, ?, ?, ?, ?, ?, ?, false, false)";
